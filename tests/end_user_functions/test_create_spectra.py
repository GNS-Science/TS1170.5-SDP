...
from end_user_functions.create_spectra import create_spectrum_from_parameters, create_enveloped_spectra
...
@pytest.mark.parametrize(
    ...
    [("Wellington", 500, ["III","IV"], [0, 0.5, 1, 1.5, 2], [0.91 , 1.84 , 1.129, 0.752, 0.564])]
)
