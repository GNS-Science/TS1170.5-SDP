...
def test_fit_td_exploratory():
    ...
    spectrum = np.array([0.86224788, 1.38337982, 1.82800424, 1.8950038 , 1.82104588,
       ...
       0.11206086, 0.10961958, 0.10717831, 0.10473703, 0.10229576,
       0.09985448, 0.09741321, 0.09497193, 0.09253065, 0.09008938,
       0.0876481 , 0.08520683, 0.08276555, 0.08032428, 0.077883  ,
       0.07544173, 0.07421994, 0.07299815, 0.07177636, 0.07055457,
       0.06933278, 0.06811099, 0.06688921, 0.06566742, 0.06444563,
       0.06322384, 0.06200205, 0.06078026, 0.05955847, 0.05833669,
       0.0571149 , 0.05589311, 0.05467132, 0.05344953, 0.05222774,
       0.05100596, 0.04978417, 0.04856238, 0.04734059, 0.0461188 ,
       0.04489701]) # spectra in g
    pga = 0.77
    sas = 1.71
    tc = 0.66
...
def test_relevant_spectrum_domain_exploratory(tc,inclusive):
    ...
    n = len(r_periods)
    assert r_spectrum == spectrum[-n:]
    assert r_periods == periods[-n:]
...
def test_Td_fit_error_exploratory():
    ...
    assert (
        pytest.approx(result) == 0.013511859172484967
    )
